...
if(isset($_POST['edit_product'])){
    ...
    if($product_title=='' or $product_desc=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_image1=='' or $product_price==''){
        ...
        if($result_update){
            ...
            echo "<script>window.open('./insert_product.php','_self')</scripts>";
        }
    }
}
